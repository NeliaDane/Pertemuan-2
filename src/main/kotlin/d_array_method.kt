fun main() {
//    sort() adalah mengurutkan data berdasarkan abjad
...
//sorted() mengurutkan abjad asccending
    ...
    print('\n')
//reverse() and reversedArray() digunakan untuk mengembalikan nilai array yang dibalik urutannya dari belakang ke depan.
